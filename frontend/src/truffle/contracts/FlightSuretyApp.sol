...
//   modifier onlyExistingAirlines() virtual  {
...
// modifier airlineHasNotVoted(address airline, address voter) virtual  {
//     require(!flightSuretyData.votedBefore(airline, voter), "This airline has already voted for the new airline");
//     _;
// }
...
//     //     require(flightSuretyData.votedBefore(newAirline), "This airline has already voted for the new airline");
//     //     _;
//     // }
...
//    *
//    */
//   function registerAirline(address airline) external onlyExistingAirlines 
//   airlineHasNotVoted(airline, msg.sender)
//   {
